...
from modules import fees_win, login_win, backend
...
class Admin:
    ...
    def __add_student_intodata(self):
        ...
        if self.valid1():
            ...
            val = (self.f_name.get(), self.m_name.get(), self.l_name.get(), self.rollno.get(), self.division_box.get(), self.address_txt.get(1.0, END),  self.father_name.get(
            ), self.mother_name.get(), self.standard_box.get(), self.dob.get_date(), self.bloodg.get(), self.doa.get_date(), self.father_occ.get(), self.mother_occ.get(), self.phoneno.get(), self.gender_box.get())
            print(val)
    ...
    def __fees_frame(self):
        ...
        Button(self.frame7, text="FEES Delete/Update", font=("Verdana", 16), bg="#3903fc", relief="groove",
               bd=2, fg="white", activebackground="#027cd9", command=lambda: fees_win.Fees(self.win)).place(x=20, y=80)
